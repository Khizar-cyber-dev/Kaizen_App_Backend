...
export const getUserCurrentData = asyncHandler(async (req, res) => {
...
export const getDonutChartData = asyncHandler(async (req, res) => {
  const { userId } = req.params;
...
export const getOverallConsistencyDays = asyncHandler(async (req, res) => {
  const { userId } = req.params;
